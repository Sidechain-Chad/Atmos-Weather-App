...
export default class extends Controller {
    ...
    async fetchWeather(city) {
        ...
        try {
            ...
            const weatherUrl = `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,precipitation,rain,showers,snowfall,weather_code,cloud_cover,pressure_msl,surface_pressure,wind_speed_10m,wind_direction_10m,wind_gusts_10m,visibility,dew_point_2m,uv_index&hourly=temperature_2m,weather_code,is_day&daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max,precipitation_sum,precipitation_probability_max,wind_speed_10m_max&timezone=auto&forecast_days=2`;
    ...
    updateDateDisplay() {
        ...
        this.dateDisplayTarget.textContent = date.toLocaleDateString('en-GB', options);
    }
    ...
    renderHourly(hourly) {
        ...
        // Loop from Current Hour -> 23:00 (End of Today only)
